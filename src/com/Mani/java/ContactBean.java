...
public class ContactBean implements Serializable{
	...
	public String validate()
	{
		...
		if(name==null || name.trim().equals(""))
			sb.append(" Name should not be blank!<br/>");
		...
		if(dob!=null)
		{										
		Pattern dateFrmtPtrn =Pattern.compile("((?:19|20)\\d\\d)-(0?[1-9]|1[012])-([12][0-9]|3[01]|0?[1-9])");
        Matcher matcher1 = dateFrmtPtrn.matcher(dob);
        if (matcher1.find()) {
            sb.append(DateHelper.validateDate(dob));
        } else 
        {
            sb.append("Enter a valid Date Format as instructed  </br>  ");
        }
		}
        ...
        if (matcher.find()) {
            ...
            sb.append("Enter a valid mob number  </br>");
        }}
